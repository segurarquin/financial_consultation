      ...
      <main>
        ...
        <section className="relative w-full min-h-[620px] md:min-h-[700px] flex items-center justify-center overflow-hidden">
          <img
            ...
            alt="ConFinEx - Consultores Financieros Expertos"
            title="ConFinEx Asesoría Financiera Profesional"
          ...
          <div className="relative z-10 w-full px-6 md:px-10 text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-background-50/15 backdrop-blur-sm border border-background-50/20 mb-6 animate-fade-in-down">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold text-background-50 leading-tight mb-5 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              Tu futuro financiero
              <br />
              <span className="text-accent-300">comienza aquí</span>
            </h1>

            <p className="text-base md:text-lg text-background-50/80 max-w-2xl mx-auto mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="group p-8 rounded-xl bg-background-100 border border-background-200/70 hover:border-primary-200 transition-all duration-300 hover:-translate-y-1 cursor-default animate-fade-in-up"
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {steps.map((step, index) => (
                <div key={index} className="relative text-center group animate-fade-in-up" style={{ animationDelay: `${index * 0.2}s` }}>
        ...
        <section id="analistas" className="w-full px-6 md:px-10 py-20 md:py-28 bg-background-50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              <div className="p-8 rounded-xl bg-background-100 border border-background-200/70 text-center group hover:border-primary-200 transition-all duration-300 cursor-default animate-fade-in-up" style={{ animationDelay: '0s' }}>
              ...
              <div className="p-8 rounded-xl bg-background-100 border border-background-200/70 text-center group hover:border-primary-200 transition-all duration-300 cursor-default animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <div className="w-20 h-20 mx-auto mb-5 rounded-full overflow-hidden bg-secondary-200">
                  <img
        ...
        <section className="w-full px-6 md:px-10 py-20 md:py-28 bg-primary-600 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-background-50 mb-4 animate-fade-in-up">
              ¿Listo para tomar el control de tus finanzas?
            </h2>
            <p className="text-base text-background-50/80 mb-8 max-w-xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              Da el primer paso hacia un futuro financiero más sólido. Agenda tu consulta hoy mismo.
            </p>
            <Link
              to="/reservar"
              className="inline-flex items-center gap-2.5 px-8 py-3.5 rounded-lg bg-accent-500 text-background-50 dark:text-foreground-950 text-base font-semibold hover:bg-accent-600 transition-all duration-200 shadow-lg shadow-accent-500/25 whitespace-nowrap cursor-pointer animate-fade-in-up"
